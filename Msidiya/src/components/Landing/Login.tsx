...
const Login: React.FC<LoginProps> = ({ onSwitchToSignup }) => {
  ...
  return (
    <div className="font-[sans-serif] p-5 ">
      ...
      <Slide direction="right" className="absolute " style={{top:"-2.692rem" , left:"-1.71rem",}}>
      <img src={ball} alt="" className="absolte rounded-br-lg balimg z-10"  />
        ...
        <Slide direction="right" >
          ...
          <div>
            ...
            <p className="text-sm mt-12 text-gray-800">
              ...
              <a href="javascript:void(0);" onClick={onSwitchToSignup} className="text-blue-600 font-semibold hover:underline ml-1">
                Register here
              </a>
            </p>
          </div>
