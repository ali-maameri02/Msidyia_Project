    ...
    try {
      ...
      if (!selectedImage) {
        ...
        if (previousImageUrl) {
          ...
          const previousImageBlob = await fetch(previousImageUrl).then((res) =>
            res.blob()
          );
          const previousImageFile = new File(
            [previousImageBlob],
            "previousImage.jpg",
            { type: previousImageBlob.type }
          );
        ...
        <Box sx={{ marginTop: "20px" }}>
          ...
          <FormControl fullWidth sx={{ marginBottom: 2 }}>
            ...
            <Select
              ...
              displayEmpty
            >
              <MenuItem value={formData.class_type || ""} disabled>
                {formData.class_type || ""}{" "}
              </MenuItem>
