...
const Navbar: React.FC = () => {
  return (
    ...
    <div>
      ...
      <div className="bg-white fixed " style={{zIndex:'9999'}} >
        <div className="flex-row flex ">
          <div className="w-full border-b-2 border-gray-200  ">
          <div style={{width:'80vw',borderBottom:'0.5px solid' ,borderBottomColor:'',zIndex:'1'}} className=" bg-blue-500 right-0 h-16 fixed  justify-between items-center mx-auto px-4 flex">
          ...
          <div className="lg:block mr-auto  hidden relative max-w-xs">
              ...
              <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                <div className="relative" >
                  <p className="p-2 bg-white text-gray-700 rounded-full transition-all duration-200 hover:text-gray-900 focus:outline-none hover:bg-gray-100 hover:cursor-pointer ">
                    <span className="items-center justify-center flex" >
                      <svg
                ...
                <div className="relative">
                  ...
                  <p className="p-1.5 hover:cursor-pointer bg-white text-gray-700 rounded-full transition-all duration-200 hover:text-gray-900 focus:outline-none hover:bg-gray-100">
                    <span className="justify-center items-center flex">
                      <span className="justify-center items-center flex">
                        <span className="items-center justify-center flex">
                          <svg
                ...
                <div className="hover:cursor-pointer justify-center items-center flex relative">
                  <img
