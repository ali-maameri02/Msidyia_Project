...
function MyTransaction() {
  ...
  if (isError)
    return <div className="ml-16 mt-16">Failed to load transactions.</div>;
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableCell>
                  <div className="font-extrabold">Created At</div>
                </TableCell>
                <TableCell>
                  <div className="font-extrabold">Action</div>
                </TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data &&
                data.map((row) => (
                  <TableRow key={row.id}>
                    <TableCell className="font-extrabold text-blue-500">
                      {row.sender}
                    </TableCell>
                    ...
                    <TableCell className="font-extrabold">
                      <div className="bg-green-500 text-white text-center text-xs rounded-xl p-2">
                        {row.type}
                      </div>
                    </TableCell>
