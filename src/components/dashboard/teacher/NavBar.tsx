    ...
    <div>
      ...
      <div className="bg-white fixed " style={{zIndex:'9999'}} >
        <div className="flex-row flex ">
          ...
          <div style={{width:'80vw',borderBottom:'0.5px solid' ,borderBottomColor:'',zIndex:'1'}} className=" bg-white right-0 h-16 fixed  justify-between items-center mx-auto px-4 flex">
